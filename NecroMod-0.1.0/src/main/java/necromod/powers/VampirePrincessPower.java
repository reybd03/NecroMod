...
public class VampirePrincessPower extends AbstractPower {
	...
	public static final String[] DESCRIPTIONS = new String[] {
			"A powerful Vampire. Deals 10 damage to a random enemy at the end of each turn. Heals for unblocked damage deal."
	};
    ...
    public void atEndOfTurn(boolean isPlayer) {
		...
		this.flash();
		AbstractDungeon.actionManager.addToTop(new DamageRandomEnemyAction(new DamageInfo(this.owner, this.DAMAGE_AMT,
